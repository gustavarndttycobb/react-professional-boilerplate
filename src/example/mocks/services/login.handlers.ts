...
import type { ILoginBody } from "../../features/Auth/models/loginBody.model";
import type { ILoginResponse } from "../../features/Auth/models/loginResponse.model";
...
import type { ISignupBody } from "../../features/Auth/models/signupBody.model";
import { LOGIN_ENDPOINT, SIGNUP_ENDPOINT } from "../../utils/endpoints";
import type { ISignupResponse } from "../../features/Auth/models/signupResponse.model";
